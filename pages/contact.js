...
const Contact = () => {
  ...
  return (
    <>
      <Head>
        <title>Contact | DentalFix | Savinesti</title>
        <meta
          name="description"
          content="Do you have any questions? Contact us via email, phone or visit us directly at our address. We are always ready to help you."
        />
      </Head>
      <Page>
        <Container>
