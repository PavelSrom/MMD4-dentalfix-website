...
const sedation = () => {
  ...
  return (
    <>
      <Head>
        <title>Sedation | Services | DentalFix | Savinesti</title>
        <meta
          name="description"
          content="You should never experience unnecessary anxiety or worry when it comes to getting the dental care you need."
        />
      </Head>
      <Page>
          ...
          <div className={classes.content}>
            <LineLength narrow>
              ...
              <BodyText>
                ...
                sedation and dental anesthesia at{' '}
                <a style={{ textDecoration: 'none' }} href="/">
                  <Span blue border>
                    DentalFix Clinic{' '}
                  </Span>
                </a>{' '}
                may be right for you. Our team believes that his patients should never
                have to experience unnecessary anxiety or worry when it comes to getting
                the dental care they need.
              </BodyText>
              <br />
              <BodyText bold>
                At DentalFix clinic, we offer sedation dentistry options for all
