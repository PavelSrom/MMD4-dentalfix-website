...
const extractions = () => {
  ...
  return (
    <>
      <Head>
        <title>Extractions | Services | DentalFix | Savinesti</title>
        <meta
          name="description"
          content="Tooth extraction performed by DentalFix dentists is a relatively quick outpatient procedure with either local, general, intravenous anesthesia, or a combination."
        />
      </Head>
      <Page>
        <Container background="#fff" className={classes.container}>
          ...
          <div className={classes.content}>
            <LineLength narrow>
              ...
              <BodyText>
                You might feel nervous, worried, or even downright terrified at the idea
                of having a tooth removed. However, the team of{' '}
                <a style={{ textDecoration: 'none' }} href="/Meet-us">
                  <Span blue border>
                    {' '}
                    high-qualified dentists
                  </Span>
                </a>{' '}
                at DentalFix clinic are here to help you!
              </BodyText>
              <br />
              <BodyText>
              ...
              <BodyText>
                ...
                extraction. Extraction means removing your damaged tooth completely.
                Dental extraction is one of the standard procedures at DentalFix.
              </BodyText>
              <br />
              <BodyText bold>
              ...
              <br />
              <BodyText>
                1. A classic extraction, which is a common type. Our dentists will numb
                your tooth before the intervention, so you won’t feel any pain. Our
                dentists use only quality tools with which they will extract your tooth.
              </BodyText>
              <br />
              <BodyText>
                2. A surgical extraction is more intricate process, where other surgical
                tools need to be used. It is the process where it’s needed to intervene
                into your gumline. This type of extraction is usually used if your tooth
                is broken or in case of wisdom teeth, which can we painful.
              </BodyText>
