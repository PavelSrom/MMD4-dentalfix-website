...
const dentalBonding = () => {
  ...
  return (
    <>
      <Head>
        <title>Dental bonding | Services | DentalFix | Savinesti</title>
        <meta
          name="description"
          content="Dental bonding is an affordable and minimally invasive approach to cosmetic dentistry."
        />
      </Head>
      <Page>
        <Container background="#fff" className={classes.container}>
          ...
          <div className={classes.content}>
            <LineLength narrow>
              ...
              <BodyText>
                For minor imperfections in a smile, conservative treatments are best.
                Dental bonding is an affordable and minimally invasive approach to
              ...
              <BodyText>
                <Span bold>- Time:</Span> Unlike crowns and veneers, which require more
                time to prepare and a second visit to place them, bonding can be completed
                in a single visit.
              </BodyText>
              <BodyText>
