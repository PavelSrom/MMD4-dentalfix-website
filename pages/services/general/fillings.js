...
const fillings = () => {
  ...
  return (
    <>
      <Head>
        <title>Fillings | Services | DentalFix | Savinesti</title>
        <meta
          name="description"
          content="When a tooth is cracked, or an old amalgam filling is leaking or failing, an inlay or onlay is an ideal way to restore the tooth."
        />
      </Head>
      <Page>
          ...
          <div className={classes.content}>
            <LineLength narrow>
              ...
              <BodyText>
                ...
                will gently remove the decayed part of your tooth and fill it with a type
                of filling you choose. Nowadays you can choose from several fillings: from
                porcelain, plastic, gold or silver amalgam.
              </BodyText>
              <br />
              <BodyText>
                All fillings are safe and proved by Health Association. After you this
                type of treatment, fillings require special dental care and hygiene,
                meaning you should visit us regularly for cleanings.
              </BodyText>
              <br />
              ...
              <br />
              <BodyText>
                Do you need dental filling? Schedule an appointment with us and together
                we will look at the possibilities we can provide to you.
              </BodyText>
