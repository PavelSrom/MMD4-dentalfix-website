        ...
        <div className={classes.content}>
          <LineLength narrow>
            ...
            <BodyText>
              ...
              dental bridge is a false tooth, usually made from porcelain in order to look
              similar as your natural tooth.
            </BodyText>
            <br />
            <BodyText>
              Dental bridges normally consist of two or more crowns next to each other to
              fill the missing space, that means not only one missing tooth. This
            ...
            <BodyText>
              ...
              gum line, and the force they withstand gets distributed along the bridge and
              its supporting crowns. Bridges are especially effective if the surrounding
              teeth need crowns. In that case, the entire bridge and crown restoration
              brings strength and function back to those teeth.
            </BodyText>
