...
const diagnosis = () => {
  ...
  return (
    <>
      <Head>
        <title>Diagnosis | Services | DentalFix | Savinesti</title>
        <meta
          name="description"
          content="DentalFix’s dentists ensure the professional attitude and complete diagnosis in order to enhance your self-confidence when you smile!"
        />
      </Head>
      <Page>
        <Container background="#fff" className={classes.container}>
          ...
          <div className={classes.content}>
            <LineLength narrow>
              ...
              <BodyText>
                Tooth pain can be unpleasant and sometimes difficult to bear. Sometimes
                the cause of pain is known, but sometimes the dental check is necessary.
              </BodyText>
              <br />
              <BodyText>
              ...
              <BodyText>
                ...
                another check-ups. Take into consideration that you should visit us at
                least once a year for regular check-up. We recommend coming twice a year
              ...
              <BodyText>
                ...
                Please, do not underestimate dental cleaning. Usually brushing and
                flossing are not enough for removing all the bacteria that can occur even
                on your teeth. Cleanings remove plague and tartar which can lead to oral
                infection.
              </BodyText>
              <br />
